    ...
    <div className="space-y-10 px-4">
      ...
      <div>
        ...
        <div className="flex justify-center px-4">
          {loading ? (<Loader />) : (<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl">
            <AnimatePresence>
              {goals?.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center mt-4 gap-2">
                      ...
                      <button
                        ...
                        className={`text-xs px-3 py-1 rounded transition ${goal.completed
